...
public class RSVPNoAdapter extends RecyclerView.Adapter<RSVPNoAdapter.MemberViewHolder> {
    ...
    class MemberViewHolder extends RecyclerView.ViewHolder {
         ...
         */
        public MemberViewHolder(View itemView, RSVPNoAdapter adapter) {
            super(itemView);
    ...
    public RSVPNoAdapter(Context context, ArrayList<String> memberList) {
        mContext= context;
