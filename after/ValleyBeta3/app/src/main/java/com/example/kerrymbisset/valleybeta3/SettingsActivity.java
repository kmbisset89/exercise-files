...
public class SettingsActivity extends AppCompatActivity implements
    ...
    //widgets
    private EditText mEmail, mCurrentPassword, mName, mPhone, mStreet, mCity, mState, mZip;
    private Button mSave;
    private ProgressBar mProgressBar;
    private TextView mResetPasswordLink;
    private CheckBox mShowEmail, mShowPhone, mShowAddress;
    private ImageView mProfileImage;
    private static final int REQUEST_CODE = 1234;
    private boolean mStoragePermissions =true;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mStreet = findViewById(R.id.input_street);
        mCity = findViewById(R.id.input_city);
        mState = findViewById(R.id.input_state);
        mZip = findViewById(R.id.input_zip);
        ...
        mShowAddress = findViewById(R.id.show_address_check);
        mShowEmail = findViewById(R.id.show_email_check);
        mShowPhone = findViewById(R.id.show_phone_check);
            ...
            /*
               ...
               */
                ...
                if (!mStreet.getText().toString().equals("")) {
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .child(getString(R.string.field_street_address))
                            .setValue(mStreet.getText().toString());
                }

                if (!mCity.getText().toString().equals("")) {
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .child(getString(R.string.field_city))
                            .setValue(mCity.getText().toString());
                }

                if (!mState.getText().toString().equals("")) {
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .child(getString(R.string.field_state))
                            .setValue(mState.getText().toString());
                }

                if (!mZip.getText().toString().equals("")) {
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .child(getString(R.string.field_zip))
                            .setValue(mZip.getText().toString());
                }
                ...
                if (!mPhone.getText().toString().equals("")) {
                 ...
                 /*
                ------ Change Showing Preferences -----
                 */

                if (mShowEmail.isChecked()) {
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .child(getString(R.string.field_show_email))
                            .setValue("YES");
                } else {
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                ...
                if (mShowPhone.isChecked()) {
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .child(getString(R.string.field_show_phone))
                            .setValue("YES");
                } else {
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                ...
                if (mShowAddress.isChecked()) {
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .child(getString(R.string.field_show_address))
                            .setValue("YES");
                } else {
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                ...
                Intent intent = new Intent(SettingsActivity.this, OpeningScreen.class);
...
//                           + singleSnapshot.getValue(User.class).toString());
                    ...
                    mStreet.setText(user.getStreet_address());
                    ...
                    if (user.getShow_email().equals("YES")) {
                        mShowEmail.setChecked(true);
                    } else {
                        mShowEmail.setChecked(false);
                    }
                    ...
                    if (user.getShow_address().equals("YES")) {
                        mShowAddress.setChecked(true);
                    } else {
                        mShowAddress.setChecked(false);
                    }
